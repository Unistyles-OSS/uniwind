...
open class HybridNativePlatformSpec_cxx {
  /**
   * The Swift <> C++ bridge's namespace (`margelo::nitro::uniwind::bridge::swift`)
   * from `Uniwind-Swift-Cxx-Bridge.hpp`.
   * This contains specialized C++ templates, and C++ helper functions that can be accessed from Swift.
   */
  public typealias bridge = margelo.nitro.uniwind.bridge.swift
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__uniwind__HybridNativePlatformSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::uniwind::HybridNativePlatformSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__uniwind__HybridNativePlatformSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if cachedCxxPart.__convertToBool() {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__uniwind__HybridNativePlatformSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__uniwind__HybridNativePlatformSpec_(newCxxPart)
      return newCxxPart
    }
  }
