...
namespace margelo::nitro::uniwind {
  ...
  public:
    ...
    explicit HybridNativePlatformSpecSwift(const Uniwind::HybridNativePlatformSpec_cxx& swiftPart):
      HybridObject(HybridNativePlatformSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline Uniwind::HybridNativePlatformSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    Uniwind::HybridNativePlatformSpec_cxx _swiftPart;
  };
