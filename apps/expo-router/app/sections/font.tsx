    ...
    <SectionScreen>
      ...
      <ListSection title="leading-3" containerClassName="p-2 items-center">
        <FontExample className="leading-3">
          This is a paragraph with very tight line height. Notice how the lines
          are very close together making it harder to read.
        </FontExample>
      </ListSection>

      <ListSection title="leading-normal" containerClassName="p-2 items-center">
        <FontExample className="leading-normal">
          This is a paragraph with normal line height. This provides comfortable
          reading experience with adequate spacing between lines.
        </FontExample>
      </ListSection>
      ...
      >
        <FontExample className="leading-relaxed">
          This is a paragraph with relaxed line height. The extra space between
          lines makes it even more comfortable to read.
        </FontExample>
      </ListSection>

      <ListSection title="leading-loose" containerClassName="p-2 items-center">
        <FontExample className="leading-loose">
          This is a paragraph with loose line height. There is generous spacing
          between the lines which can be useful for certain design contexts.
        </FontExample>
      </ListSection>
      ...
      <ListSection title="line-clamp-1" containerClassName="p-2 items-center">
        <FontExample className="line-clamp-1">
          This is a very long text that should be truncated to just one line
          with an ellipsis at the end when it overflows the container width.
        </FontExample>
      </ListSection>

      <ListSection title="line-clamp-2" containerClassName="p-2 items-center">
        <FontExample className="line-clamp-2">
          This is a longer text that should be truncated to exactly two lines
          with an ellipsis at the end when it overflows the container. This
          allows for a bit more content to be visible while still maintaining a
          clean layout.
        </FontExample>
      </ListSection>
      ...
      <ListSection title="line-clamp-3" containerClassName="p-2 items-center">
        <FontExample className="line-clamp-3">
          This is an even longer text that should be truncated to exactly three
          lines with an ellipsis at the end when it overflows the container.
          This gives us a good balance between showing content and maintaining
          layout consistency. Three lines often provide enough context for users
          to understand the content while keeping the design clean.
        </FontExample>
      </ListSection>
