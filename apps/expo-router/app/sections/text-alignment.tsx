    ...
    <SectionScreen>
      ...
      >
        <TextExample className="text-left" isMultiline>
          This is a longer text example that demonstrates left alignment with
          multiple lines. Notice how each line starts from the left edge and
          creates a clean left margin while the right side may be uneven.
        </TextExample>
      </ListSection>
      ...
      >
        <TextExample className="text-center" isMultiline>
          This is a longer text example that demonstrates center alignment with
          multiple lines. Notice how each line is centered within the container,
          creating a symmetrical appearance but with uneven left and right
          edges.
        </TextExample>
      </ListSection>
      ...
      >
        <TextExample className="text-right" isMultiline>
          This is a longer text example that demonstrates right alignment with
          multiple lines. Notice how each line ends at the right edge and
          creates a clean right margin while the left side may be uneven.
        </TextExample>
      </ListSection>
    </SectionScreen>
  );
